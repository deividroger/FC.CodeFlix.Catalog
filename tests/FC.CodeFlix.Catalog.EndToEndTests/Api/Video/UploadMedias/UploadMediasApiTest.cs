...
public class UploadMediasApiTest : IDisposable
{
    ...
    public UploadMediasApiTest(VideoBaseFixture fixture) => _fixture = fixture;
    ...
    public async Task UploadBanner()
    {
        ...
        var expectedFileName = StorageFileName.Create(videoId, nameof(DomainEntities.Video.Banner), file.Extension);

        var expectedContent = file.FileStream.ToContentString();

        var (response, output) = await _fixture.ApiClient.PostFormData<object>($"/videos/{videoId}/medias/{mediaType}", file);
    ...
    public async Task UploadThumb()
    {
        ...
        var expectedFileName = StorageFileName.Create(videoId, nameof(DomainEntities.Video.Thumb), file.Extension);
    ...
    public async Task UploadThumbHalf()
    {
        ...
        var expectedFileName = StorageFileName.Create(videoId, nameof(DomainEntities.Video.ThumbHalf), file.Extension);
    ...
    public async Task UploadTrailer()
    {
        ...
        var expectedFileName = StorageFileName.Create(videoId, nameof(DomainEntities.Video.Trailer), file.Extension);
    ...
    public async Task UploadVideo()
    {
        ...
        var expectedFileName = StorageFileName.Create(videoId, nameof(DomainEntities.Video.Media), file.Extension);
    ...
    public async Task Error422WhenMediaTypeIsInvalid()
    {
        ...
        var (response, output) = await _fixture.ApiClient.PostFormData<ProblemDetails>($"/videos/{videoId}/medias/{mediaType}", file);
