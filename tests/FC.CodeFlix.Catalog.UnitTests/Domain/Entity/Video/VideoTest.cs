...
public class VideoTest
{
    ...
    [Fact(DisplayName = nameof(ValidateStillValidationAfterUpdateToInValidState))]
    [Trait("Domain", "Video - Aggregate")]
    public void ValidateStillValidationAfterUpdateToInValidState()
    {
    ...
    public void RemoveCategory()
    {
        ...
        validVideo.Categories.Should().HaveCount(2);
    ...
    public void RemoveAllGenre()
    {
        ...
        validVideo.AddGenre(exampleId);
        validVideo.AddGenre(exampleId2);
        validVideo.Genres.Should().HaveCount(2);
    ...
    public void RemoveAllCastMembers()
    {
        ...
        validVideo.AddCastMember(exampleId);
        validVideo.AddCastMember(exampleId2);
        validVideo.CastMembers.Should().HaveCount(2);
